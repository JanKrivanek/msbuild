...
EndGlobal
        ...
        //[InlineData("/v:normal /analyze", MessageImportance.High)]
        [InlineData("/v:minimal", MessageImportance.High)]
        [InlineData("/v:minimal /analyze", MessageImportance.High)]
        [InlineData("/v:minimal /analyze", MessageImportance.Low)]
        [InlineData("/v:minimal /analyze", MessageImportance.Normal)]
        [InlineData("/v:minimal /analyze", MessageImportance.High - 1)]
